...
public:
	...
	n.param("base_controller/max_linear_x", max_linear_x, 0.1);
	n.param("base_controller/max_angular_z", max_angular_z, 0.02);
	...
	std::cout << "get_current_r: " << get_current_r() << std::endl;
